...
namespace MercDevs_ej2.Controllers
{
    public class DescripcionserviciosController : Controller
    {
        ...
        // GET: OBTENER DETALLE DE SERVICIOS POR CLIENTE - DetalleServicios
        public async Task<IActionResult> DetalleServicios(int id)
        {
            var mercydevsEjercicio2Context = _context.Descripcionservicios
                .Where(r => r.ServicioIdServicio == id)
        ...
        {
            if (descripcionservicio.Nombre != null && descripcionservicio.ServicioIdServicio != null)
            {
