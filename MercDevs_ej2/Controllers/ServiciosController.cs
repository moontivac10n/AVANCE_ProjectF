...
namespace MercDevs_ej2.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        // GET: OBTENER SERVICIOS CREADOS POR USUARIO - ServiciosPorUsuario
        public async Task<IActionResult> ServiciosPorUsuario(int id)
        {
            var mercydevsEjercicio2Context = _context.Servicios
                .Where(r => r.IdServicio == id)
                .Include(d => d.UsuarioIdUsuarioNavigation);
            return View(await mercydevsEjercicio2Context.ToListAsync());
        }
